...
/**
 * ScrambleText - Scramble text animation component - animates on mount.
 * Inspired by interface project's editorial design
 */
...
/**
 * ScrambleTextOnHover - Scramble text animation component - animates on hover.
